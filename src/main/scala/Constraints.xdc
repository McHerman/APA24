...
##Pmod Header JA
##Sch name = JA1
#set_property PACKAGE_PIN J1 [get_ports {io_ADIn}]				#ADC_A_in	
	#set_property IOSTANDARD LVCMOS33 [get_ports *]
##Sch name = JA2
#set_property PACKAGE_PIN L2 [get_ports {io_ADOut}]				#ADC_D_out	
#	set_property IOSTANDARD LVCMOS33 [get_ports {JA[1]}]
##Sch name = JA3
#set_property PACKAGE_PIN J2 [get_ports {io_DAOut}]				#DAC_D_out		
...
##Pmod Header JC
##Sch name = JC1
set_property PACKAGE_PIN K17 [get_ports {io_ADIn}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {JC[0]}]
##Sch name = JC2
set_property PACKAGE_PIN M18 [get_ports {io_ADOut}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {JC[1]}]
##Sch name = JC3
set_property PACKAGE_PIN N17 [get_ports {io_DAOut}]					
